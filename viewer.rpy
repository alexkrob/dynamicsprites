    ...
    frame:
        ...
        frame id "inner_frame":
            ...
            hbox:
                ...
                vbox:
                    spacing 10
                    text "Image Browser" color "000f" size 24
                    frame:
                        background Solid("fff8")
                        xsize 0.5
                        ...
                        vbox:
                            xfill True
                            spacing 10
                            text "Image Directory:" color "000f" size 24
                            window:
                                xoffset 10
                                xpos 0.0
                                xanchor 0.0
                            ...
                            button:
                                ...
                                text "Index Images" color "000f" size 24
                ...
                vbox:
                    spacing 10
                    text "Layers" color "000f" size 24
                    frame:
                        background Solid("fff8")
                        xysize (0.66, 1.0)
                ...
                vbox:
                    spacing 10
                    text "Preview" color "000f" size 24
                    frame:
                        background Solid("fff8")
                        xysize (1.0, 1.0)
